...
//CREAMOS EL METODO FINDER
    ...
    //añadimos la funcion para encontrar las entidades relacionadas
...
//añadimos la funcion para construir las entidades relacionadas
protected function _buildTags($tagString)
{
    // recorta los tags
    $newTags = array_map('trim', explode(',', $tagString));
    // elimina todos los tags vacios
    $newTags = array_filter($newTags);
    // reduce etiquetas duplicadas
    ...
    // Elimine las etiquetas existentes de la lista de etiquetas nuevas.
